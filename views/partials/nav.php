        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/about"
               ...
               rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About</a>
            <a href="/contact"
               class="
            ...
            <a href="/our-mission"
               class="
               <?= urlIs("/our-mission") ? "bg-gray-900 text-white" : "text-gray-300" ?>
               rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Our
              Mission</a>
          </div>
        </div>
      </div>
